...
var goldenRoutes = []string{
	...
	// SOUNDNET: event-domain filter options. Sorted position, not registration
	// position - ':' sorts before 'c', so this follows the :id routes.
	"GET /api/v2/detections/categories",
	...
	// SOUNDNET: the fork's inspection and review endpoints.
	...
	"POST /api/v2/search",
	"POST /api/v2/soundnet/detections/:id/correction",
	...
	"echo_route_not_found /api/v2/settings/*",
	"echo_route_not_found /api/v2/soundnet",
	"echo_route_not_found /api/v2/soundnet/*",
